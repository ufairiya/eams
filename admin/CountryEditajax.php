...
if (empty($action)) {
	...
	<div class='contact-content'>
		<h1 class='contact-title'>Add a Country:</h1>
		<div class='contact-loading' style='display:none'></div>
		<div class='contact-message' style='display:none'></div>
		<form action='#' style='display:none'>
			<label for='contact-name'>*Country Name:</label>
			<input type='text' id='contact-name' class='contact-input' name='fCountryName' tabindex='1001' />
			<label for='contact-lookup'>*Lookup:</label>
			<input type='text' id='contact-lookup' class='contact-input' name='fLookup' tabindex='1002' /><br>
			".$html."
			\n";
	...
	$output .= "
			<label>&nbsp;</label>
			<button type='submit' class='contact-send contact-button' tabindex='1006'>Add Country</button>
	...
	// Send the email
	$aRequest = array();
	$aRequest['fCountryName']  = isset($_POST["fCountryName"]) ? $_POST["fCountryName"] : "kkk"; 
	$aRequest['fLookup']       = isset($_POST["fLookup"]) ? $_POST["fLookup"] : "";
	$aRequest['fCurrency']     = isset($_POST["fCurrency"]) ? $_POST["fCurrency"] : "";
	$aRequest['fCurrencyCode'] = isset($_POST["fCurrencyCode"]) ? $_POST["fCurrencyCode"] : "";
