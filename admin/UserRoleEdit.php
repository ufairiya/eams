<?php
  ...
  {
    if($result = $oCustomer->addUserRole($aRequest))
	{
	  if($result['msg'] == 1)
	  {
	   $msg = "New User Added.";
                              ...
                              <?php
							   ...
							   ?>
							    <div class="alert alert-success">
                                    ...
                                    <a href="<?php echo $_SERVER['HTTP_REFERER'];?>" class="btn red mini active">Back to List</a>
								</div>
                  ...
                  <div class="portlet box blue">
                     ...
                     <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                                 ...
                                 <form action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-horizontal" id="roleform" method="post">
                                    ...
                                    <div class="control-group">
									 ...
									 <div class="control-group">
                                       ...
                                       <div class="controls">
                                          ...
                                          <label class="radio line">
                                          <input type="radio" name="fStatus" value="0" <?php if($edit_result['status'] == 0 || $edit_result['status'] == 2) { echo 'checked=checked' ;}?> />
                                          In-Active
                                          </label>  
