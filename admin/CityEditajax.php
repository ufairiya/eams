...
if (empty($action)) {
	...
	<div class='contact-content'>
		<h1 class='contact-title'>Add a City:</h1>
		<div class='contact-loading' style='display:none'></div>
		<div class='contact-message' style='display:none'></div>
		<form action='#' style='display:none'>
			<label for='contact-name'>*City Name:</label>
			<input type='text' id='contact-name' class='contact-input' name='fCityName' tabindex='1001' />
	...
	$output .= "
			<label>&nbsp;</label>
			<button type='submit' class='contact-send contact-button' tabindex='1006'>Add City</button>
	...
	// Send the email
	$aRequest = array();
	$aRequest['fCityName']  = isset($_POST["fCityName"]) ? $_POST["fCityName"] : ""; 
