<?php
  ...
  //echo '<pre>';
  //$aGroup1List = $oAssetType->getAllAssetTypeList();
  //print_r($aGroup1List);
  //exit();
  //echo '</pre>';
                        ...
                        <!-- BEGIN FORM-->
                                 ...
                                 <form action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-horizontal" id="group1" method="post">
									  ...
									  <div class="control-group">
                                       ...
                                       <div class="controls">
                                         <select class="large m-wrap fAssetTypeId" tabindex="1" name="fAssetType" id="fAssetType">
											 <option value="">Choose the Asset Type</option>
											 <?php
											  $aAssetTypeList = $oAssetType->getAllAssetTypeList();
											  foreach($aAssetTypeList as $aAssetType)
											  {
			  
											 ?>
                                             <option value="<?php echo $aAssetType['id_asset_type']; ?>" <?php if((!empty($edit_result['id_asset_type'])? $edit_result['id_asset_type']:$aRequest['fAssetType']) == $aAssetType['id_asset_type']) { echo 'selected=selected' ;}?>><?php echo $aAssetType['asset_type_name']; ?></option>
                                             <?php
											  }
											 ?>
                                          </select>
