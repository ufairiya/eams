...
$aPrint = $oMaster->getDeliveryPrint($item_id,'print');
 /*echo '<pre>';
  print_r($aPrint);
   echo '</pre>';
exit();*/
...
<TABLE cellSpacing="0" cellPadding="0" width="100%" align="center" style="font-family:'Courier New', Courier, monospace;">
  ...
  <TR class="srow">
    ...
    <?php }else {?>EXTERNAL STORE DELIVERY<?php } ?></B></FONT></TD></TR></TBODY></TABLE><BR>
...
size="2">EMAIL</FONT></TD>
              ...
              <HR style="border:solid black; border-width:1px 0 0 0;" >
...
align="right">
         ...
         <TABLE cellSpacing="0" cellPadding="5" width="100%"  align="center" border="1" style="font-family:'Courier New', Courier, monospace;">
  <TBODY>
  <TR align="center" bgColor="white">
    <TD width="2%" align="left"><B>S.NO</B></TD>
    <TD width="30%" align="left"><B>PARTICULARS</B></TD>
    <TD width="5%" align="left"><B>QUANTITY </B></TD>
     <TD width="6%" align="right"><B>UOM</B></TD>
   </TR>
   ...
   <TD align="left" ><b><?php echo $net_total;?></b></TD>
   <TD align="right"></TD>
