                        ...
                        <!-- BEGIN FORM-->
                              ...
                              You have some form errors. Please check below.
                                    ...
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input type="text" placeholder=""  tabindex="6" class="m-wrap large" name="fZipCode" data-required="1" value="<?php echo (!empty($edit_address['zipcode'])? $edit_address['zipcode']:$aRequest['fZipCode']);?>"/>
