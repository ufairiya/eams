<?php
  ...
  $aRequest = $_REQUEST;
  $allResult = $oMaster->getFaultList();
?>
<!DOCTYPE html>
...
<body class="fixed-top">
                              ...
                              <?php
							   ...
							   ?>
							    <div class="alert alert-success">
									...
									{
										echo $msg = 'New Fault Added Successfully';
									}
									else if($aRequest['msg'] == 'updatesucess')
									{
										echo $msg = 'Fault Updated Successfully';
									}
									else if($aRequest['msg'] =='delsuccess')
									{
										echo $msg = 'Fault Deleted Successfully';
									}
            ...
            <!-- BEGIN PAGE CONTENT-->
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<h4><i class="icon-globe"></i>Fault Master</h4>
								<div class="tools">
							...
							<div class="portlet-body">
								<div class="clearfix">
                                <div class="btn-group">
                                <a href="FaultEdit.php?action=Add"  role="button" class="btn green" data-toggle="modal">Add New <i class="icon-plus"></i></a>								
									</div>
								...
								<table class="table table-striped table-bordered table-hover" id="sample_1">
									...
									<tbody>
										...
										<tr class="odd gradeX">
                                            ...
                                            <td>
                                            <div class="flash" id="flash_<?php echo  $item['id_fault']; ?>"></div>
                                            <a href="FaultEdit.php?id=<?php echo  urlencode($item['id_fault']); ?>&action=edit" class="btn mini purple"><i class="icon-edit"></i>Edit</a> &nbsp; &nbsp;
                                            
                                            <a  class="delete btn mini black" href="javascript:void()" onclick=deleteBox(<?php echo  $item['id_fault']; ?>)><i class="icon-trash"></i>Delete</a>   
   ...
   <!-- END CONTAINER -->
	...
	function deleteBox(id)
	{
	  ...
	  {
		var dataString = 'data=faultdelete&fid='+ id;
		$("#flash_"+id).show();
