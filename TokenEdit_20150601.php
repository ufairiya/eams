								  ...
								  <div class="row-fluid">
                                       <div class="span12">
                                        ...
                                        <label class="control-label">Fuel Type<span class="required">*</span></label>
                                          <div class="controls" id="ItemsList">
                                           <select class="m-wrap  nextRow margin" tabindex="14" name="fFuelType">
  ...
  <option value="<?php echo $key; ?>" <?php if((!empty($aFuelInfo['id_fuel_type'])? $aFuelInfo['id_fuel_type']:$aRequest['fFuelType']) == $key) { echo 'selected=selected' ;}?>><?php echo $value; ?></option>
                                   ...
                                   <div class="row-fluid">
									  ...
									  <div class="control-group">
                                       ...
                                       <div class="controls">
									     <input type="text" class="m-wrap xsmall" tabindex="15" value="<?php echo (!empty($aFuelInfo['qty'])? $aFuelInfo['qty']:$aRequest['fQuantity']);?>"  placeholder="Quantity" style=" float:left;" name="fQuantity"> &nbsp;&nbsp;<span>Liters</span>
									   </div>
									  </div>
									 </div>
									  ...
									  <div class="control-group">
                                       ...
                                       <div class="controls">
									     <input type="text" class="m-wrap xsmall" tabindex="15" value="<?php echo (!empty($aFuelInfo['oil_qty'])? $aFuelInfo['oil_qty']:$aRequest['fOilQuantity']);?>"  placeholder="Quantity" style=" float:left;" name="fOilQuantity">
									   </div>
									  </div>
									 </div>
