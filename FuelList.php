                              ...
                              <?php
							   ...
							   ?>
							    <div class="alert alert-success">
									...
									{
										echo $msg = 'New Fuel Added Successfully';
									}
									else if($aRequest['msg'] == 'updatesucess')
									{
										echo $msg = 'Fuel Updated Successfully';
									}
									else if($aRequest['msg'] =='delsuccess')
									{
										echo $msg = 'Fuel Deleted Successfully';
									}
            ...
            <!-- BEGIN PAGE CONTENT-->
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<h4><i class="icon-globe"></i>Fuel Master</h4>
								<div class="tools">
							...
							<div class="portlet-body">
								...
								<table class="table table-striped table-bordered table-hover" id="sample_1">
									...
									<tbody>
                                      ...
                                      <a href="FuelEdit.php?id=<?php echo  $item['id_fuel']; ?>&action=edit" class="btn mini purple"><i class="icon-edit"></i>Edit</a> &nbsp; &nbsp;
