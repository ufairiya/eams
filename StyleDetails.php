<?php
  ...
  $allResult = $oStyle->getAllStyleInfo();
                              ...
                              <?php
							   ...
							   ?>
							    <div class="alert alert-success">
									...
									if($_GET['msg'] == 'success')
									{
										echo $msg = 'New Style/Order Added Successfully';
									}
									else if($_GET['msg'] == 'updatesucess')
									{
										echo $msg = 'Style/Order Updated Successfully';
									}
									else if($_GET['msg'] =='delsuccess')
									{
										echo $msg = 'Style/Order Deleted Successfully';
									}
            ...
            <!-- BEGIN PAGE CONTENT-->
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<h4><i class="icon-globe"></i>Style Details Master</h4>
								<div class="tools">
							...
							<div class="portlet-body">
								<div class="clearfix">
                                <div class="btn-group">
                                <a href="StyleDetailsEdit.php?action=Add"  role="button" class="btn green" data-toggle="modal">Add New <i class="icon-plus"></i></a>								
									</div>
								</div>
								<table class="table table-striped table-bordered table-hover" id="sample_1">
									...
									<tbody>
										...
										<tr class="odd gradeX">
											...
											<td><?php echo $item['buyerref']; ?></td>
											<td><?php echo $item['stylenumber']; ?></td>
                                            ...
                                            <td>
                                            <div class="flash" id="flash_<?php echo  $item['id_order']; ?>"></div>
                                            <a href="StyleDetailsEdit.php?id=<?php echo  urlencode($item['id_order']); ?>&action=edit" class="btn mini purple"><i class="icon-edit"></i>Edit</a> &nbsp; &nbsp;
                                            
                                            <a  class="delete btn mini black" href="javascript:void()" onclick=deleteBox(<?php echo  $item['id_order']; ?>)><i class="icon-trash"></i>Delete</a>   
...
function deleteBox(id){
  ...
  {
    var dataString = 'data=unitdelete&id='+ id;
	$("#flash_"+id).show();
