...
<body class="fixed-top">
                     ...
                     <li><a href="#">Vendor</a></li>
							   ...
							   ?>
							    <div class="alert alert-success">
									...
									{
										echo $msg = 'New Vendor Updated Successfully';
									}
									else if($_GET['msg'] =='delsuccess')
									{
										echo $msg = 'New Vendor Deleted Successfully';
									}
  ...
  <a href="AssetVendorEdit.php?action=Add"  role="button" class="btn green" data-toggle="modal">Add New <i class="icon-plus"></i></a>									   
									</div>
								...
								<table class="table table-striped table-bordered table-hover" id="sample_1">
									<thead>
										<tr>
                                            ...
                                            <th>LookUp</th>
											<th>Vendor City </th>
											<th class="hidden-480">Vendor Phone Number</th>
											<th>Status</th>
											<th>Action</th>	
									...
									<tbody>
										...
										<tr class="odd gradeX">
                                            ...
                                            <a href="AssetVendorEdit.php?id=<?php echo  urlencode($item['id_vendor']); ?>&action=edit" class="btn mini purple"><i class="icon-edit"></i>Edit</a> &nbsp; &nbsp;
