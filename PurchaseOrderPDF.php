...
$html.='
  ...
  <TR class="srow" bgColor="white">
	...
	if($purchaseitem['item_remark'] != '')
	{
	  $html.=' <TR class="srow" bgColor="white">
...
$verifyempname = $oMaster->getEmployeeInfo($polResult[modified_by]);
  ...
  <TR >
	...
	if($edit_result[0]['purchaseorderinfo']['terms_and_conditions'] != '')
	{
	
	  $html.= '<TABLE border="1" cellSpacing="0" cellPadding="0" width="100%" bgColor="white" align="center" bordercolor="#000000">
  <TBODY>
  <TR >
    <TD width="40%"><B>&nbsp;TERMS AND CONDITION  </B></TD>
   </TR>
  <TR >
  ...
  $html.='<TABLE border="0" cellSpacing="0" borderColor="black" cellPadding="0" width="100%" 
align="center">
  <TBODY></TBODY></TABLE>
<HR>
<BR>
