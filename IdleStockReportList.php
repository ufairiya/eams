<?php
 ...
 $astockReportListcount = $oReport->idleStockReportListCount($sesReportItemList);
		...
		else
		{
		 	$field = '';
              		...
              		$numrows 		= $astockReportListcount; //$oDb->num_rows;
	   	  		  	...
	   	  		  	$astockReportList 	= $oReport->idleStockReportList( $sesReportItemList, $offset, $rowsPerPage, $field, $sort);
...
<head>
   <meta charset="utf-8" />
   <title>EAMS| Idle Stock Report List </title>
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <ul class="breadcrumb">
                     ...
                     <li>
                        <a href="StockReport.php">Idle Stock Report</a>
                        <span class="icon-angle-right"></span>
                     </li>
                     <li><a href="#">Idele Stock Report List</a></li>
                  </ul>
               </div>
            </div>
            ...
            <!-- BEGIN PAGE CONTENT-->
             ...
             <div class="row-fluid profile">
					<div class="tabbable tabbable-custom">
                                ...
                                <a href="IdleStockReport.php">BACK TO FORM</a>
 ...
 <?php  if(empty($astockReportListcount))
  ...
  ?> 
	...
	<thead>
											<tr>
												<th>SLNO</th>
                                                <th><a href="?field=asset_item.id_itemgroup1&sort=<?php echo $sort;?>" class="titleLink">Item Group 1</a></th>
                                                <th><a href="?field=asset_item.id_itemgroup2&sort=<?php echo $sort;?>" class="titleLink">Item Group 2</a></th>
                                                <th><a href="?field=asset_item.asset_name&sort=<?php echo $sort;?>" class="titleLink">Item </a></th>
                                                ...
                                                <th > <a href="?field= asset_unit.unit_name&sort=<?php echo $sort;?>" class="titleLink">Unit Name</a></th>
												  <th><a href="?field=asset_item.created_on&sort=<?php echo $sort;?>" class="titleLink">Idle Days</a></th>
                                          ...
                                          <span class="photo">   <img src="assets/img/noimage.gif" alt="" height="50" width="50" /></span>
                                             <?php } ?>
                                                ...
                                                <td><?php echo $stockReport['unit_name'];?></td>
												 <td><?php echo $stockReport['idle_days'];?></td>
