<?php
  ...
  if(isset($aRequest['add']))
  {
    if($oAssetCategory->addCategory($aRequest,$_FILES))
	{
	   ...
	   echo '<script type="text/javascript">window.location.href="AssetCategory.php?msg=success";</script>';
	}
	else $msg = "Sorry";
  } //submit
 $allResult = $oAssetCategory->getAllCategoryList();
   if(isset($aRequest['Update']))
  {
    if($oAssetCategory->updateCategory($aRequest,$_FILES))
	{
	 ...
	 echo '<script type="text/javascript">window.location.href="AssetCategory.php?msg=updatesucess";</script>';
	}
	else $msg = "Sorry";
  } //update
  ...
  {
	$item_id = $_REQUEST['id'];
	$edit_result = $oAssetCategory->getCategoryInfo($item_id,'id');
	 } //edit
            ...
            <div class="row-fluid">
             ...
             <form action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-horizontal" id="form_sample_3" method="post"  enctype="multipart/form-data">
                              ...
                              You have some form errors. Please check below.
                                    ...
                                    <div class="control-group">
                                       <label class="control-label">Category Lookup<span class="required">*</span></label>
                                       <div class="controls">
                                          <input type="text" placeholder="" class="m-wrap large" name="fLookup" value='<?php echo  $edit_result['lookup'];?>' data-required="1"/>
					 ...
					 {?>
                       <button type="submit" class="btn blue" name="Update"><i class="icon-ok"></i> Update Category</button>
                         <?php } else {?>
                         <button type="submit" class="btn blue" name="add"><i class="icon-ok"></i> Add Category</button>
                        <?php }?>
