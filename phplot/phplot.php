...
class PHPlot
{
    ...
    public $browser_cache = TRUE;         // FALSE = Sends headers for browser to not cache the image,
...
//Colors and styles       (all colors can be array (R,G,B) or named color)
    ...
    public $line_styles = array('');   // single value or array
    public $dashed_style = '0-0';              // colored dots-transparent dots
    ...
    public $shading = 0;                       // 0 for no shading, > 0 is size of shadows in pixels
    ...
    function SetRGBArray($which_color_array)
    {
        if (is_array($which_color_array)) {           // User defined array
            ...
            $this->rgb_array = array(
                ...
                'blue'           => array( 83,   142,   213),
                'SkyBlue'        => array(135, 206, 235),
                'cyan'           => array(  0, 255, 255),
                'DarkGreen'      => array(  10, 172,   166),
                'green'          => array( 164, 191, 14),
                'YellowGreen'    => array(154, 205,  50),
                'yellow'         => array(220, 204,   20),
