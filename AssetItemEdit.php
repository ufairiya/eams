                     ...
                     <div class="portlet-body form">
                        <!-- BEGIN FORM-->
							...
							<?php if($_REQUEST['tab']==1){?>	
                             ...
                             <form action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-horizontal form-row-seperated" id="form_asset_item" method="post">
                            			   <div class="alert alert-error hide">
									  <button class="close" data-dismiss="alert"></button>
									  You have some form errors. Please check below.
								   </div>
                                ...
                                <h3 class="form-section">Add Item </h3>
                                  <?php if($aInvetoryItem['direct_order']!='on' ||  $aInvetoryItem['direct_order']==''|| $aInvetoryItem['direct_order']='on' && $aRequest['action'] == 'edit')
									{
                              ...
                              <?php  $aPOItemDetails= $oMaster->getPurchaseOrderItem($purchaseitem['id_po_item'],'id'); ?>
                               <input type="hidden" name="fPOUnitPrice[]" class="price"  value="<?php echo $aPOItemDetails['unit_cost'];?>"/>
                                ...
                                <td></td>
                                    ...
                                    <?php }														
									 elseif($aInvetoryItem['direct_order']=='on') {
										 $j=1; 
										 ?>    
                                    <div class="row-fluid">  
                                       ...
                                       <div class="span12 ">
                                          <div class="control-group error">
                                             ...
                                             <span class="text"><b><?php echo  $GRNNumber;?></b></span>
                                                <input type="hidden" class="m-wrap span4" name="fGRNNumber"  placeholder="GRN Number" value="<?php echo  $GRNNumber;?>">									<span class="help-inline"></span>
                                                <!--<span class="help-block">Auto created</span>-->
                                             </div>
                                          </div>
                                       </div>
                                    ...
                                    <select class="m-wrap" data-placeholder="Choose a Store"  tabindex="6"  name="fStoreId" id="fStoreId" >
									   ...
									   <div class="span4 ">
									    <div class="control-group">
										  <label class="control-label">PO No.</label>
										  <div class="controls" id="polist">
                                                <input type="text" class="m-wrap "  tabindex="7" placeholder="Purchase Order No." readonly name="fPONumber" value='<?php echo  $aInvetoryDetails['po_number'];?>'>
    ...
    return false;
				...
				if(stockqty.compare(qty)) {
				  ...
				  $("input[name='fUnitPrice[]']").each(function(){
					...
					var quantity = $(this).val(stockqty[i]);
					i++;
				});
