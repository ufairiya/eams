<?php
  ...
  if(!$oCustomer->isLoggedIn())
  {
	...
	$id_fuel_token = $aRequest['id'];
	$vtype = $aRequest['vtype'];
	if($vtype == 'outside')
	{
	  $aFuelInfo =$oMaster->getOutsideFuelTokenInfo($id_fuel_token);	
	}
	else {
	$aFuelInfo =$oMaster->getFuelTokenInfo($id_fuel_token,'id');
	}
	/*echo '<pre>';
	print_r($aFuelInfo);
	echo '</pre>';
 ...
 if(isset($aRequest['send']))
  {
	...
	if(isset($aRequest['fIsOutside']) && $aRequest['fIsOutside']=='outside')
	{
		$oFormValidator->setField("ALLTEXT", " Vehicle Reg.Number", $aRequest['fVehicleRegNumber'], 1, '', '', '', '');
	}
	else {
    ...
    if($result = $oMaster->addFuelToken($aRequest))
	{
	  $msg = "New Fuel Token Added.";
	  header("Location:TokenList.php?msg=success");	 
	 /*echo '<script type="text/javascript">window.location.href="TokenList.php?msg=success"</script>'; */
	}
   ...
   if(isset($aRequest['update']))
  {
	 /* echo '<pre<';
	  print_r($aRequest);
	  echo '</pre>'; exit();*/
    if($result = $oMaster->updateFuelToken($aRequest))
	{
	  $msg = "Update Successfully.";
		header("Location:TokenList.php?msg=updatesucess"); 
	 /*echo '<script type="text/javascript">window.location.href="TokenList.php?msg=updatesucess"</script>'; */
	}
	else $msg = $_aErrorMsg['Duplicate']; //"Sorry could not add..";
  } 
...
<head>
   <meta charset="utf-8" />
   <title>EAMS|Fuel Token Details</title>
...
<body class="fixed-top" onLoad="getGroup2ItemListing('<?php echo $aFuelInfo['id_itemgroup1'];?>','<?php echo $aFuelInfo['id_itemgroup2'];?>','<?php echo $aFuelInfo['id_asset_item']; ?>');">
         ...
         <div class="container-fluid">
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <h3 class="page-title">Fuel Token</h3>
                  <ul class="breadcrumb">
                     <li>
                        <i class="icon-home"></i>
                     ...
                     <li>
                        <a href="FuelList.php">Fuel</a>
                        <span class="icon-angle-right"></span>
                     </li>
                     <li><a href="#">Fuel Token</a></li>
                  </ul>
               </div>
            </div>
                  ...
                  <div class="portlet box blue">
                     <div class="portlet-title">
                      <?php if($aRequest['action'] == 'Add')
							{ ?>
                        <h4><i class="icon-reorder"></i>Add Fuel Token Details</h4>
                         <?php } else {?>
                          <h4><i class="icon-reorder"></i>Edit Fuel Token Details</h4>
                        <?php } ?>
                        <div class="tools">
                     ...
                     <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                            ...
                            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-horizontal form-row-seperated" id="form_sample_3" method="post">
								   <h3 class="form-section">Enter Fuel Token Details</h3>
                                      <div class="row-fluid">
                                       <div class="span4">
                                           <div class="control-group">
                                             <label class="control-label" >Token No.<span class="required">*</span></label>
                                             <div class="controls" >
                                                <input type="text" class="m-wrap " tabindex="1"  placeholder="Token Number." value="<?php echo (!empty($aFuelInfo['token_no'])? $aFuelInfo['token_no']:$aRequest['fTkNumber']);?>" name="fTkNumber" tabindex="1">
                                          ...
                                          <div class="control-group">
											  ...
											  <div class="controls">
												 <div class="input-append date date-picker" data-date="<?php echo date('d-m-Y');?>" data-date-format="dd-mm-yyyy">
													<input class="m-wrap m-ctrl-small date-picker span8" tabindex="2" size="10" type="text" value="<?php echo (!empty($aFuelInfo['token_date'])? date('d-m-Y',strtotime($aFuelInfo['token_date'])):$aRequest['fTkDate']);?>" name="fTkDate"><span class="add-on"><i class="icon-calendar"></i></span>
												 </div>
											  </div>
										   </div>
                                       </div>
									...
									<div class="row-fluid">
									  ...
									  <div class="span12 ">
                                        ...
                                        <label class="control-label">Vendor / Supplier<span class="required">*</span></label>
                                          <div class="controls">
                                             <select class="span3 m-wrap chosen" data-placeholder="Choose a Vendor" tabindex="6" name="fVendorId" id="fVendorId" onChange="getVendorItemGroup(this.value);"  tabindex="3">
                                      ...
                                      <div class="row-fluid">
                                          <div class="span4">
                                           <div class="control-group" style="background-color:#CCC;">
                                            <label class="checkbox">
                                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="fIsOutside" value="outside" id="fIsOutside" tabindex="4" <?php if(isset($aRequest['fIsOutside'])) { echo "checked=checked";} else if($aFuelInfo['vehicle_type'] == 'outside'){ echo "checked=checked";} ?>> Is Outside Vehicle ?
                                            </label>
                                           </div>
                                          </div>
                                          <div class="span6">
                                         ...
                                         <div class="controls">
                                         <input type="text" class="m-wrap medium" name="fVehicleRegNumber" tabindex="5" value="<?php echo (!empty($aFuelInfo['vehicle_reg_number'])? $aFuelInfo['vehicle_reg_number']:$aRequest['fVehicleRegNumber']);?>" />
                                         </div>
                                          </div>
                                      </div>
                                      (OR)
                                      ...
                                      <div class="span4">
                                        ...
                                        <label class="control-label">Item Group1<span class="required">*</span></label>
                                          <div class="controls">
                                             <select class="m-wrap margin chosen" tabindex="6" name="fGroup1" id="fGroup1" onChange="getGroup2ItemListing(this.value);"  >
                                      ...
                                      <div class="span3">
                                        ...
                                        <label class="control-label">Brand / Make<span class="required">*</span></label>
                                          <div class="controls" id="Group2ItemList">
                                             <select class="m-wrap chosen" tabindex="7" name="fGroup2">
                                       ...
                                       <div class="span3">
                                        ...
                                        <label class="control-label">Item<span class="required">*</span></label>
                                          <div class="controls" id="ItemsList">
                                             <select class="m-wrap  nextRow margin  chosen" tabindex="8" name="fItemName" onChange="getCMR(this.value);getUsedFuelcount(this.value);">
								   ...
								   <div class="row-fluid">
                                      <div class="span12">
                                       ...
                                       <div class="controls">
                                        <select class="m-wrap chosen" tabindex="9" name="fEmployeeId">
											...
											<?php
											 ...
											 ?>
                                             <option value="<?php echo $aEmployee['id_employee']; ?>" <?php if((!empty($aFuelInfo['id_employee'])? $aFuelInfo['id_employee']:$aRequest['fEmployeeId']) == $aEmployee['id_employee']) { echo 'selected=selected' ;}?>><?php echo $aEmployee['employee_name']; ?></option>
                                             <?php
											  }
											 ?>
                                          </select>
								  ...
								  <div class="row-fluid">
                                       <div class="span12">
                                        ...
                                        <label class="control-label">Fuel Type<span class="required">*</span></label>
                                          <div class="controls" id="ItemsList">
                                           <select class="m-wrap  nextRow margin" tabindex="10" name="fFuelType">
                                             <option value="">Choose  Fuel Type </option>
											 <?php
											  $aItemList =$oUtil->getFuelType1();
  ...
  <option value="<?php echo $key; ?>" <?php if((!empty($aFuelInfo['id_fuel_type'])? $aFuelInfo['id_fuel_type']:$aRequest['fFuelType']) == $key) { echo 'selected=selected' ;}?>><?php echo $value; ?></option>
                                   ...
                                   <div class="row-fluid">
                                      <div class="span3">
									  <div class="control-group">
                                       <label class="control-label">Fuel Quantity<span class="required">*</span></label>
                                       <div class="controls">
									     <input type="text" class="m-wrap xsmall" tabindex="11" value="<?php echo (!empty($aFuelInfo['qty'])? $aFuelInfo['qty']:$aRequest['fQuantity']);?>"  placeholder="Quantity" style=" float:left;" name="fQuantity"> &nbsp;&nbsp;<span>Liters</span>
									   </div>
									  </div>
									 </div>
                                      ...
                                      <div class="span3">
									  <div class="control-group">
                                       <label class="control-label">Oil Quantity<span class="required">*</span></label>
                                       <div class="controls">
									     <input type="text" class="m-wrap xsmall" tabindex="12" value="<?php echo (!empty($aFuelInfo['oil_qty'])? $aFuelInfo['oil_qty']:$aRequest['fOilQuantity']);?>"  placeholder="Quantity" style=" float:left;" name="fOilQuantity">
									   </div>
									  </div>
									 </div>
								    ...
								    <div class="row-fluid">
                                       <div class="span12">
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <textarea class="large m-wrap" tabindex="13" rows="3" name="fRemark"><?php echo (!empty($aFuelInfo['remarks'])? $aFuelInfo['remarks']:$aRequest['fRemark']);?></textarea>
                                             </div>
                                          </div>
                                       </div>
                                       <!--/span-->
									  ...
									  <div class="control-group">
                                       ...
                                       <div class="controls">
									    <input type="text" name="fOMR" tabindex="14" value="<?php echo $aFuelInfo['omr'];?>" id="OMR" readonly class="TxtReadonly"/>
									  </div>
									  </div>
									    </div>
										<div class="span3">
									  <div class="control-group">
                                       ...
                                       <div class="controls">
									    <input type="text" name="fCMR" tabindex="15" value="<?php echo  (!empty($aFuelInfo['cmr'])? $aFuelInfo['cmr']:$aRequest['fCMR']);?>"/>
									  </div>
									  </div>
									    </div>
									  </div>
								  ...
								  <div class="form-actions">
                                   <?php if($aRequest['action'] == 'Add')
							{ ?>  <button type="submit" class="btn blue" tabindex="16" name="send"><i class="icon-ok"></i>Add </button>   
							       <input name="action" type="hidden" value="Add"/>  
                                      <?php } else if($aRequest['action'] == 'edit'){ ?>
                                      <input type="hidden" name="fFuelTokenId" value="<?php echo $aFuelInfo['id_fuel_token'];?>"/>
