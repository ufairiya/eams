								...
								<table class="table table-striped table-bordered table-hover" id="sample_1">
									...
									<tbody>
										...
										<tr class="odd gradeX">
											...
											<a href="UserEdit.php?id=<?php echo $item['user_id']; ?>&action=edit" class="btn mini purple icn-only"><i class="icon-edit"></i></a>&nbsp; &nbsp;<a href="javascript:void()" onclick=deleteBox(<?php echo  $item['user_id']; ?>) class="btn mini red icn-only"><i class="icon-remove icon-white"></i></a>
