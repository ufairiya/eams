					...
					?>
                      <?php
							...
							$assetDepValue = $totalAssetValue - $totalAssetDepValue;
                                ...
                                $html .= '<tr><td colspan="9" style="height:20px;">&nbsp;</td></tr>
								<tr>
                                <td colspan="3" style="text-align:right; font-weight:bold; font-size: 14px;">Total Asset Actual Value</td>
                                <td colspan="1" style="text-align:right; font-weight:bold;">'.number_format($totalAssetValue,2).'</td>
                                <td colspan="4" style="text-align:right; font-weight:bold; font-size: 14px;">Total Depreciated Value</td>
                                <td colspan="1" style="text-align:right; font-weight:bold;">'.number_format($assetDepValue,2).'</td>
                                </tr>
                                </tbody>
                           </table>';
