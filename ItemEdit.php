                                ...
                                Choose Item
									...
									<?php } ?>
									 <div class="control-group" id="group1">
                                       ...
                                       <div class="controls">
									 <select class="medium m-wrap fItemGroup1Id" tabindex="2" name="fGroup1" id="fGroup1" onChange="getGroup2ItemListing();">
                                  ...
                                  <div class="control-group">
                                       ...
                                       <div class="controls">
                                         <select class="medium m-wrap fItemGroup2Id" tabindex="1" name="fGroup2" id="fGroup2" onChange="getGroup2ItemListing();">
									...
									<div id="ItemList">
                                       ...
                                       <div class="controls" >
									   <input type="text" placeholder="Enter the Item Name" class="m-wrap small" name="fItemName" data-required="1" value="<?php echo (!empty($edit_result['item_name'])? $edit_result['item_name']:$aRequest['fItemName']);?>"/>
									     </div>
                                    </div>
									 ...
									 <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input type="text" placeholder="Enter Lookup" maxlength="3" class="m-wrap small" name="fLookup" data-required="1" value="<?php echo (!empty($edit_result['lookup'])? $edit_result['lookup']:$aRequest['fLookup']);?>"/>
                                       </div>
                                    </div>                                
                                      <?php } ?>   
...
$( document ).ready(function() {
   getGroup2ItemListing();
});
function getGroup2ItemListing()
{	
$.ajax({
	type: 'POST',
	url: 'ItemLists.php',
	data: {id:$( "#fGroup2" ).val(),group1:$( "#fGroup1" ).val()},
	success: function(result){
