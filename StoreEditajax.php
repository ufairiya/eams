...
if (empty($action)) {
	...
	<div class='contact-content'>
		<h1 class='contact-title'>Add Store:</h1>
		<div class='contact-loading' style='display:none'></div>
		<div class='contact-message' style='display:none'></div>
		<form action='#' style='display:none'>
			<label for='contact-name'>*Store Name:</label>
			<input type='text' id='contact-name' class='contact-input' name='fStoreName' tabindex='1001' />
			<label for='contact-name'>*Lookup:</label>
			<input type='text' id='contact-lookup' class='contact-input' maxlength='3' name='fLookup' tabindex='1002' />
	...
	$output .= "
			<label>&nbsp;</label>
			<button type='submit' class='contact-send contact-button' tabindex='1006'>Add Store</button>
	...
	// Send the email
	$aRequest = array();
	$aRequest['fStoreName']  = isset($_POST["fStoreName"]) ? $_POST["fStoreName"] : ""; 
