            ...
            <!-- BEGIN PAGE CONTENT-->
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
                                ...
                                <h3 class="page-title">
                                 Outside Vehicles  
                                 <small>Fuel Token</small>
                              </h3>
                                <?php
								 $allResult = $oMaster->getOutsideFuelTokenList();
								?>
                                <table class="table table-striped table-bordered table-hover" id="sample_2">
									...
									<tbody>
										...
										<tr class="odd gradeX">
											...
											<td><?php echo $item['vehicle_reg_number']; ?></td>
                                            ...
                                            <td><?php echo date('d/m/Y',strtotime($item['token_date'])); ?></td>
                                           	<td>
                                            <div class="flash" id="flash_<?php echo  $item['id_fuel_token']; ?>"></div>
                                      <a href="TokenEdit.php?id=<?php echo  $item['id_fuel_token']; ?>&action=edit&vtype=outside" class="btn mini purple"><i class="icon-edit"></i>Edit</a> &nbsp; &nbsp;
