<?php
  ...
  $aRequest = $_REQUEST;
  $allResult = $oMaster->getShiftList();
?>
<!DOCTYPE html>
...
<body class="fixed-top">
                              ...
                              <?php
							   ...
							   ?>
							    <div class="alert alert-success">
									...
									{
										echo $msg = 'New Shift Added Successfully';
									}
									else if($aRequest['msg'] == 'updatesucess')
									{
										echo $msg = 'Shift Updated Successfully';
									}
									else if($aRequest['msg'] =='delsuccess')
									{
										echo $msg = 'Shift Deleted Successfully';
									}
            ...
            <!-- BEGIN PAGE CONTENT-->
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<h4><i class="icon-globe"></i>Shift Master</h4>
								<div class="tools">
							...
							<div class="portlet-body">
								<div class="clearfix">
                                <div class="btn-group">
                                <a href="ShiftEdit.php?action=Add"  role="button" class="btn green" data-toggle="modal">Add New <i class="icon-plus"></i></a>								
									</div>
								</div>
								<table class="table table-striped table-bordered table-hover" id="sample_1">
									...
									<tbody>
										...
										<tr class="odd gradeX">
                                            ...
                                            <td>
                                            <div class="flash" id="flash_<?php echo $item['id_shift']; ?>"></div>
                                            <a href="ShiftEdit.php?id=<?php echo urlencode($item['id_shift']); ?>&action=edit" class="btn mini purple"><i class="icon-edit"></i>Edit</a> &nbsp; &nbsp;
                                            
                                            <a  class="delete btn mini black" href="javascript:void()" onclick=deleteBox(<?php echo  $item['id_shift']; ?>)><i class="icon-trash"></i>Delete</a>   
   ...
   <!-- END CONTAINER -->
	...
	function deleteBox(id)
	{
	  ...
	  {
		var dataString = 'data=shiftdelete&id='+ id;
		$("#flash_"+id).show();
