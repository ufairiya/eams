...
/*  echo '<pre>';
 ...
 echo $Explode[0];
 echo '<pre>';
 print_r($_SESSION['sesMenuPermission']);
 print_r($_SESSION['sesAllMenuList']);
            ...
            <!-- BEGIN PAGE CONTENT-->
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								<div class="clearfix">
                                <div class="btn-group">
                                <a href="UserRoleEdit.php?action=Add"  role="button" class="btn green" data-toggle="modal">Add New User <i class="icon-plus"></i></a>								
									</div>
								...
								<table class="table table-striped table-bordered table-hover" id="sample_1">
									...
									<tbody>
										...
										<tr class="odd gradeX">
											...
											<a href="UserRoleMenuEdit.php?id=<?php echo  $item['role_id']; ?>&action=edit" class="btn mini purple"><i class="icon-edit"></i>Menu</a> &nbsp; &nbsp;
                                            <a href="UserRoleEdit.php?id=<?php echo  $item['role_id']; ?>&action=edit" class="btn mini purple"><i class="icon-edit"></i>Role</a> &nbsp; &nbsp;
                                            
                                            <a  class="delete btn mini black" href="javascript:void()" onclick=deleteBox(<?php echo  $item['role_id']; ?>)><i class="icon-trash"></i>Delete</a>   
