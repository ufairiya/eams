...
echo trim($StockTable);
  ...
  if($type =='New')
  {
     $ItemType = '  <div class="control-group">
                                       ...
                                       <div class="controls" >
									   <input type="text" placeholder="Enter the Item Name" class="m-wrap medium" name="fItemName" data-required="1" value=""/>
									     </div>
                                    </div>
									 <div class="control-group">
                                       <label class="control-label">Lookup<span class="required">*</span></label>
                                       <div class="controls">
                                          <input type="text" placeholder="Enter Lookup" maxlength="3" class="m-wrap small" name="fLookup" data-required="1" value=""/>
  ...
  else if($type == 'Item')
  {
    $ItemType = '<div class="control-group">
                                       <label class="control-label">Item Name<span class="required">*</span></label>
                                       <div class="controls" ><select class="medium  m-wrap nextRow " tabindex="1" name="fItemName"  id="fItemName1">
