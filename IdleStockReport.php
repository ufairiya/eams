...
<head>
   <meta charset="utf-8" />
   <title>EAMS|Idle Stock Report</title>
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <ul class="breadcrumb">
                     ...
                     <li><a href="#"> Idle Stock Report</a></li>
                  </ul>
               </div>
            </div>
               ...
               <!-- BEGIN SAMPLE FORM PORTLET-->   
                  <div class="portlet box blue">
                     <div class="portlet-title">
                          ...
                          <h4><i class="icon-reorder"></i>Idle Stock Report</h4>
                                              
                     </div>
                     <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                       
                                 <form action="IdleStockReportList.php" class="form-horizontal" id="form_sample_3" method="post">
                              ...
                              You have some form errors. Please check below.
                               ...
                               <div class="controls" id="StoreList">
                                        ...
                                        <select class=" large m-wrap chosen" data-placeholder="Choose a  Store" tabindex="2" name="fStoreId" >
                                          <option value=""></option>
                               ...
                               <div class="controls">
                                          <select  class="large  m-wrap chosen" data-placeholder="Choose Item Group 1" name="fGroup1" id="fGroupItem1" onChange="getGroup2ItemListing(this.value,this.id);">
                               ...
                               <div class="controls">
                               <select class=" large  m-wrap" data-placeholder="Choose Item Group 2"  tabindex="4" name="fGroup2" id="Group2ItemList1" onChange="getItemListing(this.value,this.id);">
							 
                                               <option value="" selected="selected" >Choose the Brand / Make</option>
											 <?php
                               ...
                               <div class="controls">
                               <select class="large  m-wrap " data-placeholder="Choose Item" name="fItemName" id="ItemList1">
							    ...
							    <div class="row-fluid">
                                       <div class="span12">
									   <div class="control-group">
									     <label class="control-label">Idle Days </label>
										   <div class="controls">
										    <select name="fOperation">
										   ...
										   <input type="text" class="small" name="fIdledays" value=""/>
