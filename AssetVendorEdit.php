 ...
 $oAssetUnit->setDb($oDb);
		...
		if($newAddressId = $oAssetAddress->addAddress($aRequest))
		{
		   $oAssetVendor->updateAddress($newAddressId,$newVendorId);
		     $msg = "New Vendor Added.";
	  		 echo '<script type="text/javascript">window.location.href="AssetVendor.php?msg=success";</script>';
		}
		else
		{
			 
			   echo '<script type="text/javascript">window.location.href="AssetVendorEdit.php?action=edit&id='.$newVendorId.'&msg=unsuccess";</script>';
		}
    ...
    if(isset($aRequest['update']))
  {
    ...
    if($oAssetVendor->updateVendor($aRequest))
	{
	 ...
	 echo '<script type="text/javascript">window.location.href="AssetVendor.php?msg=updatesucess";</script>';
	}
                        ...
                        <!-- BEGIN FORM-->
                              ...
                              You have some form errors. Please check below.
                                    ...
                                    <div class="control-group">
                                       ...
                                       <div class="control-group">
                                       <label class="control-label">Vendor Address2</label>
                                       <div class="controls">
                                    ...
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          ...
                                          <span class="help-inline">Enter Vendor Contact Person1</span>
                                       </div>
                                    </div>
                                    
                                      <div class="control-group">
                                       <label class="control-label">Vendor Contact Person2</label>
                                       <div class="controls">
                                          ...
                                          <span class="help-inline">Enter Vendor Contact Person2</span>
                                       </div>
                                    </div>
