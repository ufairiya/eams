                     ...
                     <li><a href="#">Stock </a></li>
							   ...
							   ?>
							    <div class="alert alert-success">
                                    ...
                                    <a href="StockList.php" class="btn red mini active">Back to List</a>
								</div>
								...
								<tr>
									...
									<td>
                                          ...
                                          <select class="m-wrap group2" tabindex="3" name="fGroup2" id="itemgroup1" onChange="getItemLising(this.id,this.value);">
											 ...
											 <?php
											  $aItemGroup2List =  $oMaster->getItemGroupMapList($aStockItem['id_itemgroup1'],'group1');
                                    ...
                                    <option value="0" >Choose the Item</option>
											 <?php
											  $aItemList =  $oMaster->getItemGroupMapList($aStockItem['id_itemgroup2'],'items',$aStockItem['id_itemgroup1']);
...
/* $(document).ready(function () {
		 ...
		 function getGroup2ItemListing(id,value,group2id,itemid)
		 {
			...
			var dataStr = 'action=getGroup2ItemList&Group1Id='+value+'&group2Id='+group2id;
			 $.ajax({
			   ...
			   data: dataStr,
			   cache: true,
			   success: function(result) {$("#itemgroup"+ids[1]).html(result);}
			    });
	...
	$(document).ready(function(e) {
       // getGroup2ItemListing('group1','<?php echo $aStockItem['id_itemgroup1'];?>','<?php echo $aStockItem['id_itemgroup2'];?>');
