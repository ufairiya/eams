...
class Transport extends ReportClass{
	...
	public function getFuelTokenInfo($aRequest)
	{
...
FROM
    ...
    asset_item WHERE asset_item.id_asset_item ='$lookup'";
	$aAssetInfo = array();
	if($row = $this->oDb->get_row($assetqry))
	{
...
FROM
    ...
    , asset_item.id_asset_item
	, asset_item.id_inventory_item FROM
    asset_item WHERE asset_item.id_itemgroup1 ='$id_group1' AND asset_item.id_itemgroup2 ='$id_group2'";
