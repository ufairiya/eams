...
include LIB_PATH."/DbCore.php";
	...
	*/
	...
	if ( ! class_exists ('DbCore') ) die('<b>Fatal Error:</b> DbCore requires DbCore class (DbCore.php) to be included/loaded before it can be used');
