...
if (empty($action)) {
	...
	<div class='contact-content'>
		<h1 class='contact-title'>Add a State:</h1>
		<div class='contact-loading' style='display:none'></div>
		<div class='contact-message' style='display:none'></div>
		<form action='#' style='display:none'>
			<label for='contact-name'>*State Name:</label>
			<input type='text' id='contact-name' class='contact-input' name='fStateName' tabindex='1001' />
	...
	$output .= "
			<label>&nbsp;</label>
			<button type='submit' class='contact-send contact-button' tabindex='1006'>Add State</button>
	...
	// Send the email
	$aRequest = array();
	$aRequest['fStateName']  = isset($_POST["fStateName"]) ? $_POST["fStateName"] : ""; 
